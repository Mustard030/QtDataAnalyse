...
C1_C4_last = df.loc[last_timestamp_index, C1_C4_columns].sum()
C5_C13_last = df.loc[last_timestamp_index, C5_C13_columns].sum()
C14_C40_last = df.loc[last_timestamp_index, C14_C40_columns].sum()
C40p_last = df.loc[last_timestamp_index, C40p_columns].sum()
all_last = df.loc[last_timestamp_index, organic_columns].sum()
